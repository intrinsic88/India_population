...
function Maps(){
    ...
    const [savedDatasets, setsampleTripData] = useState();
    const [savedConfig, setsavedConfig] = useState();
    const [mapToLoad, setmapToLoad] = useS
      const sampleConfig = {
        visState: {
          filters: [
            {
    ...
    const getData = async ()=>{
        ...
        setsampleTripData(JSON.parse(data));
        mapToLoad = KeplerGlSchema.load(savedDatasets, savedConfig);
    }; 
